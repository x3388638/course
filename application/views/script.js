...
function addC(){
	var t= $(this).parent("td").parent("tr").children("td:nth-child(4)").text();
	var location= $(this).parent("td").parent("tr").children("td:nth-child(5)").text();
	var cname= $(this).parent("td").parent("tr").children("td:nth-child(3)").text();
	var teacher= $(this).parent("td").parent("tr").children("td:nth-child(6)").text();
	var arr= [];
